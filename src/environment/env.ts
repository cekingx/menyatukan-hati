export const Env = {
  groomShortName: 'Gungde Wahyu',
  groomFullName: 'Ns. Anak Agung Gde Wahyu Sparsayoga S.Kep.',
  groomFatherName: 'Mangku Anak Agung Gde Bawa Sudirga',
  groomMotherName: 'Mangku Ni Made Purnawati',
  groomFamName: 'Keluarga Mangku Anak Agung Gde Bawa Sudirga',
  brideShortName: 'Mitha Frianca',
  brideFullName: 'Ns. Putu Mitha Frianca Wulandewi S.Kep.',
